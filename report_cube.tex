...
The measures were made in a cryostat at Néel Institute that allows us to raise the temperature from $5$K to $300$K. The measures were made at a given temperature with a fluctuating magnetic field (from $-0.5$T up to $0.5$T)
...
% or
\appendix[Directional control of the magnetic field] % for no appendix heading
