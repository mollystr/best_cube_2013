...
\IEEEPARstart{T}{he} plane of polarization of light propagating through a magnetic material will be rotated by propagation of light through a magnetic material causes the polarization of the light, which is known as the Faraday effect. In addition, a magnetic material is This rotation is the basis for Kerr or Faraday microscopy, in which an optical microscope is used to image the magnetic domains of a sample. Of particular interest is the observation of the evolution of magnetic domains during the paramagnetic-ferromagnetic transition that occurs in certain materials at the Curie temperature. To this end, we have worked on developing a set-up that allows us to observe this transition.
